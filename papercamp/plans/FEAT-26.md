...
### Phases
- [ ] Widen DefaultAgentsMap type and update config schema
...
- [ ] Add options descriptors to each adapter
...
- [ ] Thread model/effort through resolveAgent and buildArgs
...
- [ ] Redesign Settings page agent section
